    ...
    return (
        <Popover>
            <PopoverTrigger asChild>
                <Button className="h-full rounded-xl" disabled={!account} variant="outline">Wrap AVAX</Button>
            </PopoverTrigger>
            <PopoverContent className="w-80">
                <Card className="border-none shadow-none">
                    <CardHeader>
                        <CardTitle>Wrap AVAX</CardTitle>
                    </CardHeader>
                    <CardContent>
                        ...
                        <div className="mt-4 w-full">
                            <TransactionButton
                                ...
                                onSent="Wrapping your AVAX..."
                                onConfirmed="Successfully wrapped AVAX"
                                onError="Failed to wrap your AVAX"
