        ...
        <CardContent className="">
            ...
            <div className="mt-4 w-full">
                ...
                <div className="flex h-full items-center absolute left-1">
                        <div>{ price && outputToken ? "Price "+inputToken?.symbol+"/"+outputToken?.symbol : ""}</div>
                    </div>
            ...
            <div className="mt-4 w-full">
                <div className="w-full text-slate-600 mx-3 relative h-8">
                <div className="flex h-full items-center absolute left-1">
                        <div>{ priceInverted && outputToken && inputToken? "Price "+outputToken?.symbol+"/"+inputToken?.symbol : ""}</div>
                    </div>
                    <div className="flex h-full items-center absolute right-1">
                        <div style={{"marginRight":"24px"}}>
                            { priceInverted && outputToken ? priceInverted : ""}
                        </div>
                    </div>
                </div>
            </div>
